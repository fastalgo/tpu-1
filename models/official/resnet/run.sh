...
python3 resnet_main.py --tpu=$TPU_NAME --data_dir=gs://bert-pretrain-data/imagenet/imagenet-2012-tfrecord/ --model_dir=gs://bert-pretrain-data/imagenet/$INFER_TPU_NAME/ --num_cores=1024 --train_batch_size=32768 --enable_lars=True --train_steps=3519 --mode=train
python3 resnet_main.py --tpu=$INFER_TPU_NAME --data_dir=gs://bert-pretrain-data/imagenet/imagenet-2012-tfrecord/ --model_dir=gs://bert-pretrain-data/imagenet/$INFER_TPU_NAME/ --num_cores=8 --train_batch_size=32768 --enable_lars=True --train_steps=3519 --mode=eval
